...
class StockPickingBatch(models.Model):
    ...
    def _compute_projects(self):
        for record in self:
            # Collect project IDs using list comprehension
            project_ids = [picking.project_transfer.id for picking in record.picking_ids if picking.project_transfer]
            # Assign the project IDs to the Many2many field
