...
class Project(models.Model):
    ...
    def action_show_sales(self):
        ...
        # Batch transferin adı ile eşleşen sale order'ları bul
    ...
    def action_show_purchases(self):
        ...
        # Batch transferin adı ile eşleşen purchase order'ları bul
    ...
    def action_show_transfers(self):
        ...
        # Batch transferin adı ile eşleşen stock.picking'leri bul
        transfers = self.env['stock.picking'].search([('project_transfer', '=', self.name)])
